'use client'
import { navbarBlackList, navbarContactIcons, navbarTabs } from '@settings'
		...
		<div className='fixed w-full z-[100]'>
			<AnimatePresence>
				{showInfo && (
					...
					>
						<div className='h-60 w-full flex-center gap-8 bg-tertiary-shadow transition-all duration-500 text-primary-contrast-15 overflow-hidden'>
